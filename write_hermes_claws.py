...
# Hermes is a fully autonomous reasoning agent 
hermes = HermesAgent(model="NousResearch/Hermes-3-Llama-3.1-8B")
router = BatonRouter()
  ...
  return (
    <div className="page-wrapper animate-fade-in">
      ...
      <div className="section-header" style={{ marginTop: '5rem', marginBottom: '2rem' }}>
        <h1 className="section-title" style={{ fontSize: '2.5rem' }}>2. Baton Native SDK Bridges & Agents</h1>
        <p className="section-subtitle" style={{ maxWidth: '800px' }}>
          If you are building an agent from scratch, our suite of native "Claw" adapters and pre-built agents provide robust plumbing for different architectures.
        </p>
      </div>
      ...
      <div className="z-block">
        <div className="z-text">
          <div>
            <h2>Hermes Agent</h2>
            <p>A fully autonomous, pre-packaged reasoning agent optimized for the Baton router. Designed to run massive local LLMs with self-correction.</p>
          </div>
        </div>
        <div className="z-code">
          <CodeTabs codeBlocks={hermisCode} />
        </div>
      </div>
